        ...
        <div class="modal-content">
            <form id="form-add-warta" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Add New Warta Umum</h5>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" name="type" value="umum" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form-edit-warta" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Edit Warta Umum</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="description" class="col-sm-2 col-form-label">Title</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="title" id="input-title" rows="8" placeholder="enter title" required></textarea>
                            <input type="hidden" name="type" value="umum" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
...
<div class="modal fade" id="preview-warta-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg h-100 d-flex flex-column justify-content-center my-0" role="document">
        <div class="modal-content">
            ...
            <object id="warta-iframe-modal" width="100%" height="450"></object>
            @else
            <object id="warta-iframe-modal" width="100%" height="450"></object>
...
<div class="row" id="warta-umum-page">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-5 text-sm-center text-md-left">
                        <h4 class="mb-4">Warta Umum</h4>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="warta-umum-datatable">
                        <thead>
                        <tr>
                            <th>Title</th>
                            <th>Uploader</th>
