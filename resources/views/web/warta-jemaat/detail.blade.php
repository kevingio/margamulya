...
<div class="home">
    ...
    <div class="home_content">
        <a href="{{ url('warta-jemaat') }}" class="tag">Warta Jemaat</a>
        ...
        <div class="row row-lg-eq-height">
            <div class="col-lg-9 mb-5">
                <div class="post_content">
                    ...
                    <object data="https://docs.google.com/gview?embedded=true&url={{ url('/').$warta->path }}" width="100%" height="700">
                        Download file : <a href="{{ $warta->path }}">{{ $warta->title }}</a>
                    </object>
                    @else
                    ...
                    <div class="similar_posts">
                        <div class="post_comment">
                            <div class="post_comment_title">Warta Jemaat</div>
