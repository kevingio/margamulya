...
<div class="sidebar_title_container">
    <div class="sidebar_title">Anniversary</div>
    <div class="sidebar_slider_nav">
        <div class="custom_nav_container sidebar_slider_nav_container">
            ...
            <ul class="custom_dots custom_dots_vid">
                @foreach($anniversary->chunk(5) as $date)
                <li class="custom_dot custom_dot_vid @if($loop->first) active @endif"><span></span></li>
                @endforeach
            </ul>
...
<div class="sidebar_section_content mb-5">
    ...
    <div class="sidebar_slider_container">
        <div class="owl-carousel owl-theme sidebar_slider_vid">
            ...
            @foreach($anniversary->chunk(5) as $chunk)
            <div class="owl-item">
